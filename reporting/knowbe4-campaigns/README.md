...
- [`Knowbe4Campaigns.sanitized.json`](Knowbe4Campaigns.sanitized.json) -- Logic App workflow. KnowBe4 API base URL, Key Vault reference, and destination connection are placeholders.
...
1. Open `Knowbe4Campaigns.sanitized.json`. Replace placeholders: KnowBe4 API base URL (it differs by region), Key Vault URI, destination connection details.
