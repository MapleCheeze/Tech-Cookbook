...
- [`ImpossibleTravelLogicApp.sanitized.json`](ImpossibleTravelLogicApp.sanitized.json) -- Logic App workflow. Tenant, subscription, RG, Sentinel workspace, and connector references are placeholders.
...
1. Open `ImpossibleTravelLogicApp.sanitized.json` and replace placeholders for your environment.
